...
case class Obj(x:Int,date:String,num:String)

object Example1 extends SparkOp{
...
//        val r1=sc.wholeTextFiles("E:\\ehl\\文档\\工作\\研判\\passcar_utf8\\").filter(!_._2.contains("无牌")).map { _._2.split(",")(1) }
//        val directories = r1.collect()
